/* 
gcc -O3 -march=native -ffast-math -std=c99 -o nn nn.c -lm
...
#define TRAIN_IMG_PATH "./Datasets/MNIST/train-images.idx3-ubyte"
#define TRAIN_LBL_PATH "./Datasets/MNIST/train-labels.idx1-ubyte"
